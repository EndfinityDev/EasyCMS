...
public class BuildAssetPackage
{
    ...
    public static void CreateCarBundle(in UnityEngine.Object selectionObject, in List<string> ignorePaths = null)
    {
        try
        {
    ...
    static void RemoveOldAssetBundle(in string assetFilePath)
    {
        if (File.Exists(assetFilePath))
            File.Delete(assetFilePath);
    }

    static List<string> ProcessDirectory(in string targetDirectory, in List<string> ignorePaths)
    {
        try
        {
            List<string> pathList = new List<string>();
    ...
    static bool ShouldIgnorePath(in string path, in List<string> ignorePaths)
    {
    ...
    static bool ComparePaths(in string path1, in string path2)
    {
